...
> **Note (2026-08-10):** the sketch below predates ADR-0004's pivot to Yjs and still
...
> actual schema is `src/sync/protocol.ts`; ADR-0005 documents the full set of decisions
> behind it. This section is kept as historical context, not rewritten in place.
